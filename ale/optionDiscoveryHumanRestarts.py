...
setOfTransitions, T = DataCollectionHumanStarts.buildTransitionMatrix(ale, actionSet, maxNumFrames, setOfTransitions,
                                                                      randomStart)
while len(T) < maxNumFrames:
    for i in range(6):
        randomStart = np.load('humanStarts/' + gameName + '_' + str(i) + '.npy')
        setOfTransitions, listTransitions = DataCollectionHumanStarts.buildTransitionMatrix(ale, actionSet,
                                                                                            maxNumFrames,
                                                                                            setOfTransitions,
                                                                                            randomStart)
